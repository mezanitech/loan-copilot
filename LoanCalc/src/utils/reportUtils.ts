...
export const reportStyles = `
    ...
    body { 
        ...
        margin: 0;
        color: #1F2937;
        background: linear-gradient(135deg, #9575CD 0%, #5E92F3 100%);
    }
    ...
    .page-header {
        ...
        align-items: center;
        padding: 16px 30px;
        border-bottom: 3px solid #8B7BC4;
        margin-bottom: 20px;
    }
    ...
    h1 { 
        color: #8B7BC4;
        font-size: 32px;
        border-bottom: 4px solid #8B7BC4;
        padding-bottom: 14px;
        margin-bottom: 28px;
        margin-top: 0;
    }
    ...
    .summary-row {
        ...
        justify-content: space-between;
        padding: 16px 0;
        border-bottom: 1px solid rgba(139, 123, 196, 0.2);
    }
    ...
    th {
        background: linear-gradient(135deg, #8B7BC4 0%, #60A5FA 100%);
        color: white;
        padding: 16px 14px;
        text-align: left;
        font-weight: 700;
...
/**
 * Generate footer HTML for reports (appears at bottom of document)
 */
export function generateReportFooter(): string {
    return `
        <div class="page-footer">
            <div class="footer-brand">Generated by Loan Copilot • ${new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</div>
            <div class="footer-disclaimer">
                ...
                <div class="disclaimer-text">
                    ...
                    Loan Copilot is not responsible for any financial decisions made based on this information.
                    Interest rates, payment amounts, and loan terms should be confirmed with your financial institution.
                </div>
            </div>
        </div>
    `;
...
/**
 * Wrap HTML content in a complete HTML document with styles, header, and footer
 * Headers and footers will repeat on each page
 */
